...
async function renPageQuestion()
{
    ...
    if (response.status >= 200 && response.status < 300) {
        ...
        let indexNow=100,indexquestionItems=0,indexNowQuestionItems=0;
        let questionItemsHtml='';
        while(indexNowQuestionItems<questionGroupTotal&&indexNow<questionGroupPart+100)
        {            
        ...
        for(let i =indexNow;i<questionGroupPart+100;i++)
        {
            questionItemsHtml+=`
            <div class="day-box">
                <div class="day-box__header d-flex justify-content-between align-items-center">
