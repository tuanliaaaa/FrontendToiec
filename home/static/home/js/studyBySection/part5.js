...
async function renPageLesson() {
    ...
    if (response.status >= 200 && response.status < 300) {
        ...
        let questionItemsHtml = response.data.data.map((item, index) => {
            ...
            attachmentsHtml+=`<div class="answer__label">${item.questionList[0].question}</div> `;
        ...
        <div class="page-container">
            <div class="page__header">
                <a class="header__left" href="/home">
                    ...
                    <div class="header__title">Part 5. Điền vào câu</div>
                </a>
            </div>
            <div class="page__content">
                ...
                <div class="page-content__mid">
                    <h4>Câu hỏi:</h4>
                    <b>A word or phrase is missing in each of the sentences below. Four answer choices are given below each
                        sentence. Select the best answer to complete the sentence. Then mark the letter (A), (B), (C), or (D) on
                        your answer sheet</b>
                    <p>Hướng dẫn: Một từ hoặc cụm từ bị thiếu trong mỗi câu dưới đây. Bốn lựa chọn trả lời được đưa ra dưới mỗi
                        câu. Chọn câu trả lời đúng nhất để hoàn thành câu. Sau đó đánh dấu chữ cái (A), (B), (C) hoặc (D) trên
                        phiếu trả lời của bạn</p>
                </div>
