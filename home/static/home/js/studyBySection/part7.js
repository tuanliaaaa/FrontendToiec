        ...
        <div class="page-container">
            <div class="page__header">
                <a class="header__left" href="/home">
                    ...
                    <div class="header__title">Part 7. Đọc hiểu đoạn văn</div>
                </a>
            </div>
            <div class="page__content">
                ...
                <div class="page-content__mid">
                    <h4>Câu hỏi:</h4>
                    <b>In this part you will read a selection of texts, such as magazine and newspaper articles e-mails, and
                        instant messages. Each text or set of texts is followed by several questions. Select the best answer for
                        each question and mark the letter (A), (B), (C), or (D) on your answer sheet. </b>
                    <p>In this part you will read a selection of texts, such as magazine and newspaper articles e-mails, and
                        instant messages. Each text or set of texts is followed by several questions. Select the best answer for
                        each question and mark the letter (A), (B), (C), or (D) on your answer sheet. </p>
                </div>
